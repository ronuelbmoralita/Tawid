  ...
  const ScheduleItem = ({ item }: { item: typeof schedules[0] }) => {
    ...
    return (
      <View style={{ padding: 16, borderRadius: 16, gap: 6, backgroundColor: 'white', elevation: 2 }}>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: 8, gap: 4 }}>
          {allDays.map(day => {
            ...
            return (
              <View
                key={day}
                style={{
                  backgroundColor: isAvailable ? colors.primary : '#f5f5f5',
                  borderWidth: 1,
                  borderColor: isAvailable ? colors.primary : 'gray',
                  paddingHorizontal: 8,
                  paddingVertical: 4,
                  borderRadius: 8,
                }}>
                <Text style={{
                  fontSize: 12,
                  color: isAvailable ? colors.light : 'gray',
                  fontWeight: '500'
                }}>
                  {day}
                </Text>
