    ...
    return (
      <View
        ...
        <View>
          ...
          <Text style={{ fontSize: 20, color: '#555' }}>{from}</Text>
        </View>
        <View style={{
          alignItems: 'center',
        ...
        <View>
          ...
          <Text style={{ fontSize: 20, color: '#555' }}>{to}</Text>
        </View>
      </View>
    );
  };
    ...
    >
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 6 }}>
        {item.weeklySchedule.map((day) => (
          ...
          >
            <Text style={{ fontSize: 12, color: colors.dark, fontWeight: '600' }}>{day}</Text>
          </View>
        ))}
      </View>
      ...
      {/* Note */}
      {item.note ? (
        <Text style={{ fontSize: 12, color: '#888' }}>Note: {item.note}</Text>
      ) : null}
      ...
      {role === 'Customer' && (
        ...
        >
          <Text style={{ color: colors.light, fontSize: 16, fontWeight: '700' }}>Book Now</Text>
        </TouchableOpacity>
      )}
      ...
      {role === 'Admin' && (
        <View style={{ flexDirection: 'row', gap: 10 }}>
          ...
          >
            <Text style={{ color: colors.light, fontSize: 16, fontWeight: '700' }}>Edit</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text style={{ color: colors.light, fontSize: 16, fontWeight: '700' }}>Delete</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
