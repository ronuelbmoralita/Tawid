        ...
        <View style={{
          ...
          <TextInput
            style={{
              ...
              borderRadius: 100,
              paddingHorizontal: 50,  // increased padding to avoid overlap
          ...
          <View style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={{ marginBottom: 20 }}>
                <Text style={{ fontSize: 16, fontWeight: '600', color: colors.dark, marginBottom: 10 }}>
                  Boat Type
                </Text>
                <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                  {boatTypeOptions.map(type => (
                    <FilterChip
                      key={type}
                      label={type}
                      selected={filters.boatTypes.includes(type)}
                      onPress={() => toggleFilter('boatTypes', type)}
                    />
                  ))}
                </View>
              </View>
                ...
                <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                  <TextInput
                    ...
                    onChangeText={(value) => {
                      ...
                      setFilters(prev => ({ ...prev, priceRange: { ...prev.priceRange, min: num } }));
                    }}
                  />
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) => {
                      ...
                      setFilters(prev => ({ ...prev, priceRange: { ...prev.priceRange, max: num } }));
                    }}
                  />
                </View>
              </View>
