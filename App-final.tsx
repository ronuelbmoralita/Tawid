...
export default function App() {
  ...
  // REMOVED instant toggle - now status is changed through modal
              ...
              <View key={schedule.id} style={[
                ...
                <View style={styles.cardHeader}>
                  ...
                  <View style={styles.badges}>
                    ...
                    {/* Status is now clickable to open modal */}
                    <TouchableOpacity 
                      style={[
                        styles.status,
                        { backgroundColor: schedule.status === 'Available' ? '#4CAF50' : '#FF6B6B' }
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.modalContainer}>
          <View style={styles.modal}>
            ...
            <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.row}>
                <TouchableOpacity 
                  style={[styles.option, status === 'Available' && styles.optionActive]}
                  onPress={() => setStatus('Available')}
                >
                  <Text style={[styles.optionText, status === 'Available' && styles.optionTextActive]}>✅ Available</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[styles.option, status === 'Unavailable' && styles.optionActive]}
                  onPress={() => setStatus('Unavailable')}
                >
                  <Text style={[styles.optionText, status === 'Unavailable' && styles.optionTextActive]}>🚫 Unavailable</Text>
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: 'white', padding: 16, borderRadius: 12, borderLeftWidth: 4, borderLeftColor: TURQUOISE, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
