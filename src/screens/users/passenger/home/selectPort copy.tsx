    ...
    <>
      <Animated.View style={{ marginBottom: 4, opacity, transform, paddingHorizontal: 15 }}>
        ...
        <Animated.View style={{ transform: [{ scale }] }}>
          <TawidCard
            color={selectedValue ? colors.brand : '#94A3B8'}
            style={{ padding: 0 }}
          >
            <TouchableOpacity
              style={{
            ...
            >
              <Text
                style={{
                  fontSize: 16,
                  color: selectedValue ? colors.black : 'rgba(0,0,0,0.4)',
          ...
          {portOptions.map((item) => (
            <TouchableOpacity
              ...
              style={{
                ...
                justifyContent: 'space-between',
                alignItems: 'center',
                backgroundColor: item === selectedValue ? colors.brand + '10' : colors.white,
                borderBottomWidth: 1,
            ...
            >
              <Text
                style={{
                  fontSize: 16,
                  color: item === selectedValue ? colors.brand : '#1A6B65',
